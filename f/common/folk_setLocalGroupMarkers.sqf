...
// Markers seen by players in TAKISTANI MILITIA slots.
	...
	case "bis_tk_ins":
	{
		...
		["GrpINS_A1", 1, "A", "ColorRed"] spawn fnc_folk_localGroupMarker;
		["GrpINS_A2", 1, "B", "ColorBlue"] spawn fnc_folk_localGroupMarker;		
		["GrpINS_A3", 1, "C", "ColorGreen"] spawn fnc_folk_localGroupMarker;		
...
// Markers seen by players in INSURGENT (CHDKZ) slots.
	...
	case "ins":
	{
		...
		["GrpA2INS_A1", 1, "A", "ColorRed"] spawn fnc_folk_localGroupMarker;
		["GrpA2INS_A2", 1, "B", "ColorBlue"] spawn fnc_folk_localGroupMarker;		
		["GrpA2INS_A3", 1, "C", "ColorGreen"] spawn fnc_folk_localGroupMarker;		
...
// Markers seen by players in BRITISH ARMED FORCES slots.
	...
	case "bis_baf":
	{
		...
		["GrpBAF_A1", 1, "A", "ColorRed"] spawn fnc_folk_localGroupMarker;
		["GrpBAF_A2", 1, "B", "ColorBlue"] spawn fnc_folk_localGroupMarker;		
		["GrpBAF_A3", 1, "C", "ColorGreen"] spawn fnc_folk_localGroupMarker;		
		...
		["GrpBAF_SUP1",  6, "SUP", "ColorYellow"] spawn fnc_folk_localGroupMarker;
		...
		["GrpBAF_TNK1",  7, "RDG", "ColorRed"] spawn fnc_folk_localGroupMarker;	
